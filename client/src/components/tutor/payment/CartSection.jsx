...
const CartSection = ({ classItem }) => {

  const handleClickPayment = async () => {
    let data = await postPayment(classItem.HocPhi * 24 * classItem.fee / 100);
    console.log("====================================");
    console.log(data);
    console.log("====================================");
    if (data && data.EC === 0) {
  ...
  return (
    <div className="public-shopping-cart-section">
            ...
            <div className="shopping-body-text">
              <div className="shopping-body-bottom">
                <div className="student-wishist-header student-shopping-header">
                  <p className="two">Lớp</p>
                  <p className="two"></p>
                  <p className="two"></p>
                  <p className="two"></p>
                  <p className="two"> Học phí</p>
                </div>
                <div className="faq-review-wrap">
                  <div className="faq-review-item">
                    <div className="faq-review-item-content">
                      <button className="cross-btn-shopping" style = {{width: "10%"}} onClick={() => setSelectedClass(null)}>
                        <svg
                      ...
                      <div className="faq-review-data" style={{display: "block"}}>
                        <div className="faq-review-data-top">
                          ...
                          <a href="/parents/course-profile">{classItem.TieuDe}</a>
                        </div>
                        <div className="faq-review-data-bottom">
                          <p>
                            Thời gian:<span>{classItem.ThoiGian}</span> <br/>
                            Địa điểm:<span>{classItem.DiaDiem}</span>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="amount" style={{padding: '0 20px'}}>{classItem.HocPhi} VND / h</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="amount-sidebar public-shopping-cart">
                <div className="about-sidebar-wrap">
                  <div className="amunt-detalis">
                    <ul>
                      <li>
                        Học phí tháng đầu <span>{classItem.HocPhi * 24} VND</span>
                      </li>
                      <li>
                        Phần trăm phí nhận lớp<span>{classItem.fee} %</span>
                      </li>
                      <li>
                    ...
                    <h3>
                      Tổng:
                      <span />
                      {classItem.HocPhi * 24 * classItem.fee / 100}
                    </h3>
                  </div>
