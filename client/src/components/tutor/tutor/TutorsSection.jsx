          ...
          <div className="course-item-4">
            <div className="course-item-5-card">
              ...
              <div className="course-item-5-card-info">
                ...
                <p className="course-item-5-card-info-price">100k/h</p>
              </div>
              <a href="single-course.html" className="course-item-5-card-head">
                Hỗ trợ ôn thi cuối kỳ toán
              </a>
          ...
          <div className="course-item-4">
            <div className="course-item-5-card">
              ...
              <div className="course-item-5-card-info">
                ...
                <p className="course-item-5-card-info-price">125k/h</p>
              </div>
              <a href="single-course.html" className="course-item-5-card-head">
                Học sinh học chương trình quốc tế
              </a>
              <div className="course-item-5-card-footer">
                <p className="course-item-5-card-footer-review align-self-center">
                  <svg
          ...
          <div className="course-item-4">
            <div className="course-item-5-card">
              ...
              <div className="course-item-5-card-info">
                ...
                <p className="course-item-5-card-info-price">130k/h</p>
              </div>
              <a href="single-course.html" className="course-item-5-card-head">
                Gia sư nữ, mục tiêu 7đ.
              </a>
              <div className="course-item-5-card-footer">
                <p className="course-item-5-card-footer-review align-self-center">
                  <svg
          ...
          <div className="course-item-4">
            <div className="course-item-5-card">
              ...
              <div className="course-item-5-card-info">
                ...
                <p className="course-item-5-card-info-price">Thỏa thuận</p>
              </div>
              <a href="single-course.html" className="course-item-5-card-head">
                Giúp bạn qua môn
              </a>
          ...
          <div className="course-item-4">
            <div className="course-item-5-card">
              ...
              <div className="course-item-5-card-info">
                ...
                <p className="course-item-5-card-info-price">150k/h</p>
              </div>
              <a href="single-course.html" className="course-item-5-card-head">
                Gia sư nam, học sinh muốn vào TĐN
              </a>
              <div className="course-item-5-card-footer">
                <p className="course-item-5-card-footer-review align-self-center">
                  <svg
